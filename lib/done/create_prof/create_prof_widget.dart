...
class _CreateProfWidgetState extends State<CreateProfWidget> {
  ...
  void initState() {
    ...
    _model.pnumberTextController ??= TextEditingController();
    _model.pnumberFocusNode ??= FocusNode();
  }
                  ...
                  children: [
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  _model.uploadedFileUrl == ''
                                      ? 'https://jzgenddakcmrkyritewj.supabase.co/storage/v1/object/public/sining_medias/ProfilePics/default.png?t=2023-10-17T06%3A05%3A02.039Z'
                                      : _model.uploadedFileUrl,
                                  'https://jzgenddakcmrkyritewj.supabase.co/storage/v1/object/public/sining_medias/ProfilePics/default.png?t=2023-10-17T06%3A05%3A02.039Z',
                                ),
                                fit: BoxFit.cover,
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: widget.accType == 'Performer'
                              ? 'Stage Name'
                              : 'Company Name',
                          hintStyle: FlutterFlowTheme.of(context)
                              .labelMedium
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(8.0, 10.0, 8.0, 0.0),
                      child: TextFormField(
                        controller: _model.pnumberTextController,
                        focusNode: _model.pnumberFocusNode,
                        autofocus: true,
                        obscureText: false,
                        decoration: InputDecoration(
                          labelStyle: FlutterFlowTheme.of(context)
                        ...
                        validator: _model.pnumberTextControllerValidator
                            .asValidator(context),
                        inputFormatters: [
                    ...
                    if (widget.accType == 'Performer')
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(0.0, 20.0, 0.0, 0.0),
                        child: FlutterFlowDropDown<String>(
                          multiSelectController:
                              _model.classificationValueController ??=
                          ...
                          onMultiSelectChanged: (val) =>
                              setState(() => _model.classificationValue = val),
                        ),
                      ),
                    Padding(
                      padding:
                        ...
                        onPressed: () async {
                          await currentUserReference!.update({
                            ...createUsersRecordData(
                              ...
                              phoneNumber: _model.pnumberTextController.text,
                            ...
                            ...mapToFirestore(
                              {
                                'skillset': _model.classificationValue,
                              },
                            ),
                          });
